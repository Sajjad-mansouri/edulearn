...
class TestRegisterApiView:
    ...
    @pytest.fixture
    def url(self):
        return reverse("accounts-api:register")
...
class TestRegisterInstructorApiView:
    ...
    @pytest.fixture
    def url(self):
        return reverse("accounts-api:register_instructor")
...
class TestLoginApiView:
    ...
    @pytest.fixture
    def url(self):
        return reverse("accounts-api:login")
...
class TestLogoutApiView:
    ...
    @pytest.fixture
    def url(self):
        return reverse("accounts-api:logout")
