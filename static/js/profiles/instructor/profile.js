...
class InstructorProfilePage {
    ...
    getDummyProfile() {
        return {
            ...
            avatar_url: 'https://ui-avatars.com/api/?name=Sarah+Chen&background=8B5CF6&color=fff&size=160',
            cover_url: '',
            ...
            biography: 'Passionate about machine learning and AI. Over a decade of experience in research and industry.',
            professional_title: 'Senior Data Scientist & AI Researcher',
            organization: 'MIT',
            years_of_experience: 12,
            introduction_video: 'https://youtube.com/watch?v=example',
            resume: '',
            application_status: 'approved',
            is_verified: true,
            verification_date: '2024-01-15T10:00:00Z',
            rejection_reason: '',
            skills: ['Python', 'Machine Learning', 'Deep Learning', 'TensorFlow', 'Data Science', 'NLP'],
            education: [
                {
                    id: 1,
            ...
            experience: [
                {
                    ...
                    startDate: '2015',
                    endDate: '2018',
                    description: 'Led AI research team'
                }
            ],
            social_links: [
                {
                    id: 1,
                    platform: 'linkedin',
                    address: 'https://linkedin.com/in/sarahchen'
                },
                {
                    id: 2,
                    platform: 'github',
                    address: 'https://github.com/sarahchen'
                }
            ],
            languages: [
                {
